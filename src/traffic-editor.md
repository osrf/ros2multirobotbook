...
The GUI uses the RMF coordinate system when annotating waypoints and lanes.
The system has its origin at the top left corner of the floor plan and its X & Y axes along the positive horizontal and positive vertical directions, respectively.
However, maps generated by robots may have origin elsewhere and further be oriented and scaled differently.
